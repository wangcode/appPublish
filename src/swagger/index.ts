...
const _addToApiObject = (target: any, name: any, apiObjects: any, content: any) => {
...
const _desc = (type: any, text: any) => (target: any, name: any, descriptor: any) => {
  descriptor.value[type] = text;
  _addToApiObject(target, name, apiObjects, { [type]: text });
  return descriptor;
};

const _params = (type: any, parameters: any) => (target: any, name: any, descriptor: any) => {
...
const request = (method: any, path: any) => (target: any, name: any, descriptor: any) => {
...
const middlewares = (middlewares: any) => (target: any, name: any, descriptor: any) => {
  descriptor.value.middlewares = middlewares;
  return descriptor;
};

const responses = (responses = { 200: { description: 'success' } }) => (target: any, name: any, descriptor: any) => {
